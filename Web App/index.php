					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2024-02-24">
						</div>
						<div class="form-group col-md-2">
				  ...
				  <div class="card-body">										
					...
					<div class="tab-content">
						<div id="itemReportsTab" class="container-fluid tab-pane active">
							<br>
							<p>Download reports for items using any format you want </p>
						...
						<div id="purchaseReportsTab" class="container-fluid tab-pane fade">
							<br>
							 <p>Download reports for purchases using any format you want </p>
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
						...
						<div id="vendorReportsTab" class="container-fluid tab-pane fade">
							<br>
							<p>Download reports for vendors using any format you want </p>
